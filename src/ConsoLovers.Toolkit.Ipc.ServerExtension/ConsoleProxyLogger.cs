// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ConsoleProxyLogger.cs" company="ConsoLovers">
...
public class ConsoleProxyLogger : IServerLogger
{
   #region Constructors and Destructors

   public ConsoleProxyLogger(ServerLogLevel logLevel)
   {
      LogLevel = logLevel;
